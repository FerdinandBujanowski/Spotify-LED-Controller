...
public class DebugNode extends LogicNode {
    ...
    public DebugNode(int nodeIndex, JointType jointType) {
        super(
                nodeIndex,
                new InputJoint[] { new InputJoint(JointType.getCopyOfDataTypeByJointType(jointType), "Input") },
                new OutputJoint[] { new OutputJoint(JointType.getCopyOfDataTypeByJointType(jointType), "Output") }
        );
    }
